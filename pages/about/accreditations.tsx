  ...
  return (
    <Layout>
      <main className="w-full mt-4">
        <div className="flex justify-center">
          ...
          >
            <div className="h-full grid place-items-center ">
              <div>
                <h1 className="text-primary font-semibold">Accreditations</h1>
                <div className="flex justify-center">
        ...
        <div className="flex justify-center">
          <ul className="flex w-3/4 mt-12 md:uppercase md:justify-between justify-evenly items-center md:p-4 sm:py-4 border-b-2 rounded-xl bg-green">
            ...
            <li className="md:mr-4 md:hidden">
              <a
                className={`text-gray-600 md:p-4 sm:py-4 sm:text-[10px] hover:text-primary font-[Outfit] relative ${
                  activeTab === "about" ? "font-bold" : "font-bold"
                }`}
                href="#about"
                onClick={() => handleTabClick("about")}
        ...
        <div className="w-full flex justify-center">
          {activeTab === "about" && (
            <div className="w-3/4 my-28 gap-12 flex md:flex-row flex-col  items-center my-16 justify-between ">
          ...
          {activeTab === "faq" && (
            <div className="w-3/4 my-28 gap-12 md:flex-row flex-col flex items-center my-16 justify-between ">
              <div className="md:w-1/2 w-full flex flex-col gap-6 mt-4 items-start my-16 justify-start">
...
export default AccreditationTabContent;
