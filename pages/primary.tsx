      ...
      <main className="mt-4 mb-12">
        ...
        >
          ...
          >
            ...
            <h1 className="text-primary capitalize">Primary Years Programme</h1>
        ...
        <section className="flex justify-center">
          <div className="w-[80%] grid grid-rows-1">
            ...
            <div className="w-full md:my-16 my-4 bg-primary flex justify-center items-center py-4">
              <div className="md:w-1/2 w-3/4 gap-6 bg-transparent flex flex-col justify-center items-center">
                <h2 className="text-center sm:text-base text-[yellow] font-bold font-['Outfit']">
                  Useful Documents
                </h2>
                <h4 className="w-full text-center md:text-base text-sm text-white font-normal font-['Outfit']">
                  Early Years Foundation Stage, GHA Primary : A Guide for
                  Parents
                </h4>
