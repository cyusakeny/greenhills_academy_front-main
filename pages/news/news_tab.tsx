...
const News_tab = () => {
  ...
  return (
    <div className="flex justify-center">
      <div className="mt-16 w-full flex flex-col md:flex-row gap-2 justify-center">
        <div className="w-3/4 p-4">
          <div
            className="h-[500px] w-full flex items-end pb-12"
            style={{
              backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.8)), url(/images/gh1.png)`,
          ...
          >
            <div className="ml-8">
              <Link href="/news/new">
                <span className="text-[yellow] py-2 px-8 text-center bg-[#018C79] font-semibold font-['Outfit']">
                  Fashion
                </span>
              </Link>
          ...
          <div className="sm:my-4 md:my-12">
            <h2 className="font-bold text-primary">Latest News</h2>
            <hr className="w-[75px] h-1.5 bg-primary mb-4" />
            {newsData.map((event, index) => (
              <NewsCard key={index} newsData={event} />
            ))}
          </div>
        </div>
        <div className="w-1/3 p-4">
          <div
            className="w-full h-[250px] flex items-center"
            style={{
          ...
          />
          <h5 className="font-semibold text-xl mt-4 mb-2">
            The Key is in Investing in Time
          </h5>
          <div className="text-sm text-gray-600 flex flex-row justify-start gap-1 items-center">
            <BiCalendar />
          ...
          <div className="w-full my-8 border-b-2 h-auto gap-2 py-2 flex pb-2">
            <div className="w-1/2">
              <div
            ...
            <div>
              <div className="flex-col justify-start items-start gap-1 inline-flex">
                <p className="text-sm text-primary font-bold">Event1</p>
                <p className="font-bold ">Hive gala algorand stellar</p>
              </div>
            </div>
          </div>
          <div className="w-full my-8 border-b-2 h-auto gap-2 py-2 flex pb-2">
